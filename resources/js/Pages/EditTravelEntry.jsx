...
export default function EditTravelEntry({ diary, destinations = [] }) {
    ...
    const [previewPhotos, setPreviewPhotos] = useState(diary.photos || []);
    ...
    const removePhoto = (index) => {
        ...
        // If it's a new photo (index >= original photos count)
        if (index >= (diary.photos?.length || 0)) {
            const newPhotoIndex = index - (diary.photos?.length || 0);
            setNewPhotos(newPhotos.filter((_, i) => i !== newPhotoIndex));
        } else {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        patch(route('travel-diary.update', diary.id));
    };
            ...
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <div>
                            <h1 className="text-4xl font-bold">Edit Travel Entry</h1>
                            <p className="text-gray-300 mt-2">Update your Mindanao adventure</p>
                        </div>
                    </motion.div>
                </div>
            </div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                ...
                                <p className="text-gray-600 font-medium">Click to upload more photos</p>
